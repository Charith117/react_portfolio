...
const Hero = () => {
  return (
    ...
    <div className={styles.content}>
        ...
        <a href="jayanithacharith7@gmail.com" className={styles.contactBtn}>Contact me</a><a href="jayanithacharith7@gmail.com" className={styles.contactBtn}>Contact me</a>
    </div>
